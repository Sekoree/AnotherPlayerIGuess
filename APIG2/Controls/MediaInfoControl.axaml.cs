...
public class MediaInfoControl : TemplatedControl
{
    ...
    public static readonly StyledProperty<double> PrepProgressProperty = AvaloniaProperty.Register<MediaInfoControl, double>(
        nameof(PrepProgress));

    public double PrepProgress
    {
        get => GetValue(PrepProgressProperty);
        set => SetValue(PrepProgressProperty, value);
    }

    public static readonly StyledProperty<bool> ShowProgressProperty =
        AvaloniaProperty.Register<MediaInfoControl, bool>(
            nameof(ShowProgress));
    ...
    public MediaInfoControl()
    {
        ...
        CopyUrlCommand = new AsyncRelayCommand(async () =>
        {
            if (CurrentMedia is null)
                return;
